...
def _log_progress(msg: str) -> None:
    """One line to subprocess log; prefer binary buffer flush for pipes (avoid duplicate prints)."""
    try:
                        ...
                        if len(loc1) > 0:
                            ...
                            for j in range(in2out_count):
                                ...
                                if on_points[in2out[j]]:
                                    ...
                                    # Handle longitude wrapping, then slope (avoid div-by-zero after wrap)
                                    if abs(x2 - x1) > 90:
                                        x2 = x2 + 360
                                        if abs(x2 - x1) > 90:
                                            x2 = x2 - 720
