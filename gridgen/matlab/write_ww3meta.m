...
% Write grid type, coordinate system flag, and closure type
% FLAGLL: 'T' for spherical (lon/lat in degrees), 'F' for Cartesian
% CSTRNG: 'NONE' for no closure, 'SMPL' for simple closure, 'TRPL' for tripole
