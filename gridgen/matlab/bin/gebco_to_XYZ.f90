MODULE Grid
   INTEGER         , DIMENSION(:),      ALLOCATABLE :: depth,sdev,depthg,depthf
...
!
      ...
      iret=NF90_INQ_VARID (ncid, 'z', varid(2))
...
!      IF (lon.GE.-61.9.AND.LAT.LT.16.57.AND.LON.LT.-60.75.AND.LAT.GE.15.73) TESTS= 0
 ...
 WRITE(6,*) 'DLON  ... :',cos(0.5*(latmax+latmin)*acos(-1.)/180),dx
 dy=dxdy(2)*4E7/360.
 WRITE(6,*) 'DLAT  ... :',(latmax-latmin),dy
