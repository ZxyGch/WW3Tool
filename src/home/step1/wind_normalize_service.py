"""
Wind normalization service extracted from Step 1 UI logic.
"""
...
def _transform_wind_chunks_for_pool(
    ...
    """Pure array transform for multiprocessing."""
...
def _get_available_memory_bytes() -> int:
    """Best-effort available memory detection used for chunk sizing."""
    try:
        import psutil
...
class WindNormalizeService:
    """Normalizes wind NetCDF files to WW3-friendly layout."""
